package com.galaxe.sqliteapplication
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        printName.setOnClickListener{
            ...
            var a =cursor.getString(cursor.getColumnIndex(DBHelper.AGE_COL)) + "\n"


            Toast.makeText(this,"Values are $n $a",Toast.LENGTH_SHORT).show()
